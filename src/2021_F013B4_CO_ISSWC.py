...
for feature in layer:
    ...
    myplot.setproperty('PDATE', '2021-04-20')
    ...
    fdata = list()
    fdata.append({'date':'2021-06-08','value':51.9})
    fdata.append({'date':'2021-06-22','value':51.9})
    fdata.append({'date':'2021-07-14','value':45.4})
    myplot.setproperty('FEAMN',fdata)
    cdata = list()
    cdata.append({'date':'2021-04-01','value':'Apply RoundUp (glyphosate)'})
    cdata.append({'date':'2021-04-15','value':'Apply Velum Total (fluopyram)'})
    cdata.append({'date':'2021-04-16','value':'Apply Prowl (pendimethalin)'})
    cdata.append({'date':'2021-05-11','value':'Apply RoundUp (glyphosate)'})
    cdata.append({'date':'2021-06-15','value':'Apply RoundUp (glyphosate)'})
    cdata.append({'date':'2021-08-07','value':'Apply Carbine 50WG (flonicamid)'})
    cdata.append({'date':'2021-08-14','value':'Apply Carbine 50WG (flonicamid)'})
    cdata.append({'date':'2021-08-21','value':'Apply Carbine 50WG (flonicamid)'})
    cdata.append({'date':'2021-10-21','value':'Apply Ginstar (diuron, thidiazuron) and CottonQuik (urea sulfate, ethephon)'})
    cdata.append({'date':'2021-11-05','value':'Apply Ginstar (diuron, thidiazuron)'})
    myplot.setproperty('CH_NOTES',cdata)
    tdata = list()
    tdata.append({'date':'2021-04-07','value':'Strip tillage'})
    tdata.append({'date':'2021-12','value':'Root pull, rip, moldboard plow, disk, and land plane'})
