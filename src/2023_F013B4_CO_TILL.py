...
expmeta = {
    ...
    'OBJECTIVES':'See Thorp, K. R., Bandaru, P., Bronson, K. B., Smith, D. R., 2026. Conventional versus conservation tillage for sprinkler-irrigated Arizona cotton production. Applied Engineering in Agriculture. In review.',
    'EXP_NARR':'See Thorp, K. R., Bandaru, P., Bronson, K. B., Smith, D. R., 2026. Conventional versus conservation tillage for sprinkler-irrigated Arizona cotton production. Applied Engineering in Agriculture. In review.',
    'MAIN_FACTOR':'Type of tillage: beds and furrows, on-the-flat, strip tillage, no tillage',
    'FACTORS':'Four spring tillage treatments',
    'TRT_COUNT':4,
    'REP_NO':3,
    'METHODS':'See Thorp, K. R., Bandaru, P., Bronson, K. B., Smith, D. R., 2026. Conventional versus conservation tillage for sprinkler-irrigated Arizona cotton production. Applied Engineering in Agriculture. In review.',
    'EXPER_TYPE':'ET001',
    ...
    'EXP_YEAR': '2023',
    'EXP_DUR':1,
    'CR_SYSTEM':'Cotton with overhead sprinkler irrigation and various spring tillage treatments after winter barley cover crop',
    'LAST_NAME':'Thorp',
    'FIRST_NAME':'Kelly',
    'MID_INITIAL':'R',
    ...
    'SUITE_OBJ':'See Thorp, K. R., Bandaru, P., Bronson, K. B., Smith, D. R., 2026. Conventional versus conservation tillage for sprinkler-irrigated Arizona cotton production. Applied Engineering in Agriculture. In review.',
...
for feature in layer:
    ...
    for doy in ['184','194','201','208','215','236']:
        ...
        if not math.isnan(row.iloc[0]['NAWF'+doy]):
            nawf.append({'date':date,'value':round(row.iloc[0]['NAWF'+doy],1)})
    if nawf:
...
for feature in layer:
    ...
    for plot in plots:
        if plot.plt_label == zon_label[:3]:
            ...
            myzone.setproperty('pid',plot.getid())
            found=True
            break
    if not found:
