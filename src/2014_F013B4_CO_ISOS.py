...
expmeta = {
    ...
    'EXP_YEAR': '2014',
    'EXP_DUR':1,
    'CR_SYSTEM':'Cotton on raised beds with overhead sprinkler irrigation after fallow',
    'LAST_NAME':'Thorp',
    'FIRST_NAME':'Kelly',
    'MID_INITIAL':'R',
...
for feature in layer:
    ...
    myplot.setproperty('PDATE', '2014-05-02')
    myplot.setproperty('PLYR', 2014)
    myplot.setproperty('PLDAY', 122)
    ...
    fdata = list()
    fdata.append({'date':'2014-05-27','value':60.0})
    fdata.append({'date':'2014-06-17','value':60.0})
    fdata.append({'date':'2014-07-08','value':60.0})
